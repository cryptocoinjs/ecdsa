...
function sha256 (msg) {
  return crypto.createHash('sha256').update(new Buffer(msg, 'utf8')).digest()
}
...
describe('ecdsa', function () {
  ...
  describe('recoverPubKey', function () {
    ...
    describe('with i ∈ {0,1,2,3}', function () {
      // bringing in 'message' brings in a lot.
  ...
  describe('sign', function () {
    ...
    it('should sign with low S value', function () {
      var hash = sha256('Vires in numeris')
